...
```
Ivan
├── ivan.py                  # Main application (uses llm-api-server)
...
├── hashicorp_docs_index/    # Cached documentation index (auto-generated)
└── ivan-extension/          # Chrome extension for Salesforce
```
